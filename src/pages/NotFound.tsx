...
export default function NotFound() {
  ...
  return (
    <section className={['on-green', styles.wrap].join(' ')}>
      <div className={['shell', styles.pad].join(' ')}>
        <p className="eyebrow">404</p>
        <h1 className={styles.title}>That page isn't here.</h1>
        <p className={[styles.note, 'measure-tight'].join(' ')}>
          It may have moved, or the link may be old. The work is all in one place,
          or you can call Angus on{' '}
