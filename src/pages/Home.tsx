...
import { Kept } from '../sections/Kept'
 ...
 * reference; this is the same nine numbers collected as an index, which is how
 * a set of drawings opens.
 *
 * The frame that assembles as you scroll is A-06 and it stays here. It was
...
const SHEETS: Sheet[] = [
  ...
  { number: 'A-03', name: 'Kept', target: 'kept-heading' },
  { number: 'A-04', name: 'Selected work', target: 'work-heading' },
  { number: 'A-05', name: 'The name', target: 'name-heading', dark: true },
  { number: 'A-06', name: 'How it works', target: 'approach-heading' },
  { number: 'A-07', name: 'For architects', target: 'architects-heading' },
  { number: 'A-08', name: 'In their words', target: 'said-heading' },
  { number: 'A-09', name: 'What happens next', target: 'enquiry-heading', dark: true },
]
